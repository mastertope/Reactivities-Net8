...
import { formatDateHelper } from '../../../lib/util/util';

type Props = {
    activity: Activity;
}

export default function ActivityDetailsHeader({activity} : Readonly<Props>) {
    ...
    return (
        ...
        <Box sx={{
            ...
            <Box>
                ...
                <Typography variant="subtitle1">{formatDateHelper(activity.date)}</Typography>
